...
if (time >= 0 && time <= 14) {
    ...
    console.log('Невірно вказані хвилини')
}
...
if (day >= 1 && day <= 10) {
    ...
    console.log('Невірно вказан числа')
}
...
switch (dAy) {
    case 1:
        console.log('Понеділок: курси');
        break;
    case 2:
        console.log('Вівторок: тренування на ноги');
        break;
    case 3:
        console.log('Середа:курси та розтяжка');
        break;
    case 4:
        console.log('Четвер: тренування прес ');
        break;
    case 5:
        console.log('Пятниця:курси');
        break;
    case 6:
        console.log('Субота: розтяжка');
        break;
    case 7:
        console.log('Неділя: чілл');
        break;
    default:
